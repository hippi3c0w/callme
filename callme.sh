...
sleep 5
echo "Name,Given,Name,Additional,Name,Family">/home/hippi3c0w/tools/numberGenerator/import.csv
...
extension=`cat /home/hippi3c0w/tools/numberGenerator/numberphone.txt | wc -l`
	...
	do
		...
		echo "$2$i,$2$i,*,contacts,Mobile,$fill">>/home/hippi3c0w/tools/numberGenerator/import.csv
	done
